  ...
  return (
    <div className='Work container-fluid container-lg py-5 px-4  px-md-5' id="work">
      ...
      <div className="row px-0 px-lg-5 mt-3 ">
        <div className="col-12 col-md-6">
          <div className="work-box p-4">
            <a href="https://res.cloudinary.com/jajja-group-of-company/image/upload/v1664136060/eissfanwpcileovgxvgb.png" target="_blank" data-lightbox="gallery-mf">
              <div className="work-img ">
                <img src={require('../assets/Products/academy.png')} alt="Boosten-Academy" className="img-fluid imgHover img" ></img>
              </div>
            </a>
            <div className="work-content ">
              <div className="row">
                <div className="col-sm-8">
                  <a href="https://github.com/Ahmadjajja/boosten-academy-react-web-main.git" target="_blank" className="w-title text-decoration-none text-secondary h2 headingHover">Boosten Academy App</a>
                  <div className="w-more mt-1">
                    <span className="text-secondary">Web App Design & Development</span> <br />
                    <span className="w-date text-primary">A Web application build on React JS and Firebase</span>
                  </div>
                ...
                <div className="col-12 col-sm-4">
                  <div className="w-like">
                    <a href="https://boosten-academy.web.app/" target="_blank">
                      <i className="fa-solid fa-desktop hover"></i>
                    </a>
                  </div>
                </div>
        ...
        <div className="col col-md-6 ">
          <div className="work-box px-4 p-md-4">
            <a href="https://res.cloudinary.com/jajja-group-of-company/image/upload/v1664136505/lfudsxaqx8xa2lmthywc.png" target="_blank" data-lightbox="gallery-mf">
              <div className="work-img ">
                <img src={require('../assets/Products/academyDashboard.png')} alt="Bank-App" className="img-fluid imgHover img" ></img>
              </div>
            </a>
            <div className="work-content ">
              <div className="row">
                <div className="col-sm-8">
                  <a href="https://github.com/Ahmadjajja/boosten-academy-dashboard-main.git" target="_blank" className="w-title text-decoration-none text-secondary h2 headingHover">Boosten Dashboard</a>
                  <div className="w-more mt-1">
                    <span className="text-secondary">Web App Design & Development</span> <br />
                    <span className="w-date text-primary">A Dashboard Web application build on React Js and Firebase</span>
                  </div>
                </div>
                <div className="col-12 col-sm-4">
                  <div className="w-like">
                    <a href="https://dashboard-boosten-academy.web.app/" target="_blank">
                      <i className="fa-solid fa-desktop hover"></i>
                    </a>
                  </div>
                </div>
