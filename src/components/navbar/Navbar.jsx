    ...
    <div class="Navbar ">
      <nav className="navbar navbar-expand-lg navbar-dark " >
        <div className="container-fluid d-flex space-between pb-2 pt-3 px-4 px-md-5">
          <Link to="#/" className="navbar-brand border border-success border-2 py-2 rounded-circle btn fw-light text-success fw-bold" href="#"><b>AJ</b></Link>
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul className="navbar-nav  mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <a className="nav-link btn  text-success border border-success border-2 py-2 rounded-pill " href="https://drive.google.com/file/d/1szxAIb6wNo1iQsetPZjDWPMPWAhFu4Ka/view?usp=share_link"><b className='px-1'>CV</b></a> 
              </li>
            </ul>
          </div>
        </div>
